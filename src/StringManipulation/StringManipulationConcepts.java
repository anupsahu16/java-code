...
public class StringManipulationConcepts {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('i', str1.indexOf('i', str.indexOf('i')+1)+1));//3rd occurrence of i
		System.out.println(str1.indexOf('i',str1.indexOf('i', str1.indexOf('i', str.indexOf('i')+1)+1)+1 ));//4th occurrence of i
...
//		System.out.println(stt1.substring(stt1.indexOf("is", stt1.indexOf("is", stt1.indexOf("is", stt1.indexOf("is")+1)+1))));
		System.out.println(stt1.substring(stt1.indexOf("is", stt1.indexOf("is", stt1.indexOf("is")+1)+1)+3, stt1.length()));
